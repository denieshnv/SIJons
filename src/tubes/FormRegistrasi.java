...
public class FormRegistrasi extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        try{
            if(txtuser.getText().equals("")||txtpass.getPassword().equals("")||txtketikpassword.getPassword().equals("")||txtnama.getText().equals("")){
                ...
                String simpan = "insert into login values('"+txtuser.getText()+"','"+String.valueOf(txtpass.getPassword())+"','"+txtnama.getText()+"')";
                st = con.createStatement();
            ...
            JOptionPane.showMessageDialog(this, "Akun Sudah Terdaftar","Pesan",JOptionPane.WARNING_MESSAGE);
             hapuslayar();
        }
